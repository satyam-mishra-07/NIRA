...
BEHAVIORAL_DECAY_RATE = 0.01
BEHAVIORAL_CONFIDENCE_CAP = 0.9
BEHAVIORAL_MIN_OBSERVATIONS = 3
REFLECTION_INTERVAL = 5
PERSONALITY_STABILIZE_INTERVAL = 20
PERSONALITY_MAX_ADJUSTMENT = 0.3
HOMEOSTASIS_RATE = 0.005
PERSONALITY_VARIANCE_RANGE = 0.03
REFLECTION_DECAY_MULTIPLIER = 3.0
